...
[<assembly: AssemblyVersionAttribute("4.3.12")>]
[<assembly: AssemblyFileVersionAttribute("4.3.12")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.3.12"
    let [<Literal>] AssemblyFileVersion = "4.3.12"
