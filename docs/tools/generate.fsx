...
let website = "/Delegate.XrmDefinitelyTyped"

let githubLink = "http://github.com/delegateas/Delegate.XrmDefinitelyTyped"

// Specify more information about your project
let info =
  [ "project-name", "XrmDefinitelyTyped"
    "project-author", "Delegate A/S"
    "project-summary", "Tool to generate TypeScript declaration files for MS CRM dynamics client-side coding."
    "project-page", "http://delegateas.github.io/"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Delegate.XrmDefinitelyTyped" ]
...
let version =
  let a = Assembly.LoadFile(Path.Combine(bin, @"XrmDefinitelyTyped/XrmDefinitelyTyped.exe"))
