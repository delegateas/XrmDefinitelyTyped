...
e)};a.setApiUrl=function(a){XQW.ApiUrl=a};a.setApiVersion=function(a){XQW.ApiUrl=XQW.getDefaultUrl(a)};a.request=g;a.sendRequest=e;a.promiseRequest=function(a,g,h,l){return XQW.promisifyCallback(function(c,k){return e(a,g,h,c,k,l)})}})(XrmQuery||(XrmQuery={}));var Filter;
...
linkKey:a+"@odata.nextLink"}}));if(0==a.value.length)return new b(a,f,c,e);var d=a.value[0];f=f.filter(function(a){return d[a.linkKey]});return new b(a,f,c,e)};return b}(n),n=function(){function a(a){this.requestType=a;this.additionalHeaders=[];this.getObjectToSend=function(){return null}}a.prototype.promise=function(){return e(this.execute.bind(this))};a.prototype.execute=function(a,d){void 0===d&&(d=function(){});this.executeRaw(a,d,!0)};a.prototype.executeRaw=function(a,d,c){var b=this;void 0===
d&&(d=function(){});void 0===c&&(c=!1);return XrmQuery.sendRequest(this.requestType,this.getQueryString(),this.getObjectToSend(),function(f){return c?b.handleResponse(f,a,d):a(f)},d,function(a){return b.additionalHeaders.forEach(function(d){return a.setRequestHeader(d.type,d.value)})})};return a}();a.Query=n;var q=function(a){function b(d,b,c){var f=a.call(this,"GET")||this;f.entitySetName=d;f.id=b;f.relatedNav=c;f.specialQuery=void 0;f.selects=[];f.expands=[];f.expandKeys=[];f.ordering=[];f.skipAmount=
null;f.topAmount=null;return f}__extends(b,a);b.Get=function(a){return new b(c(a).toString())};b.Related=function(a,f,e){return new b(c(a).toString(),f,c(e).toString())};b.prototype.handleResponse=function(a,b,c){t.followLinks(JSON.parse(a.response,g),this.expandKeys,b,c)};b.prototype.getFirst=function(a,b){this.top(1);this.execute(function(d){return a(d&&0<d.length?d[0]:null)},b)};b.prototype.promiseFirst=function(){return e(this.getFirst.bind(this))};b.prototype.getQueryString=function(){var a=
this.entitySetName;this.id&&this.relatedNav&&(a+="("+this.id+")/"+this.relatedNav);if(this.specialQuery)return a+this.specialQuery;var b=[];0<this.selects.length&&b.push("$select="+this.selects.join(","));0<this.expands.length&&b.push("$expand="+this.expands.join(","));this.filters&&b.push("$filter="+this.filters);0<this.ordering.length&&b.push("$orderby="+this.ordering.join(","));null!=this.skipAmount&&b.push("$skip="+this.skipAmount);null!=this.topAmount&&b.push("$top="+this.topAmount);return a+
(0<b.length?"?"+b.join("&"):"")};b.prototype.select=function(a){this.selects=h(a);return this};b.prototype.selectMore=function(a){this.selects=this.selects.concat(h(a));return this};b.prototype.expand=function(a,b){var d=c(a).toString();this.selects.push(d);this.expandKeys.push(d);var f=[];b&&f.push("$select="+h(b));this.expands.push(d+(0<f.length?"("+f.join(";")+")":""));return this};b.prototype.filter=function(a){this.filters=c(a);return this};b.prototype.orFilter=function(a){this.filters?this.filters=
Filter.or(this.filters,c(a)):this.filter(a);return this};b.prototype.andFilter=function(a){this.filters?this.filters=Filter.and(this.filters,c(a)):this.filter(a);return this};b.prototype.order=function(a,b){this.ordering.push(c(a)+" "+b);return this};b.prototype.orderAsc=function(a){return this.order(a,"asc")};b.prototype.orderDesc=function(a){return this.order(a,"desc")};b.prototype.skip=function(a){this.skipAmount=a;return this};b.prototype.top=function(a){this.topAmount=a;return this};b.prototype.maxPageSize=
function(a){this.additionalHeaders.push({type:"Prefer",value:"odata.maxpagesize="+a});return this};b.prototype.includeFormattedValues=function(){this.additionalHeaders.push(p);return this};b.prototype.useFetchXml=function(a){this.specialQuery="?fetchXml="+encodeURI(a);return this};b.prototype.usePredefinedQuery=function(a,b){this.specialQuery="?"+a+"="+b;return this};return b}(n);a.RetrieveMultipleRecords=q;q=function(a){function b(b,c,e){var d=a.call(this,"GET")||this;d.entitySetName=b;d.id=c;d.relatedNav=
e;d.selects=[];d.expands=[];d.expandKeys=[];return d}__extends(b,a);b.Related=function(a,f,e){return new b(c(a).toString(),f,c(e).toString())};b.Get=function(a,f){return new b(c(a).toString(),f)};b.prototype.handleResponse=function(a,b,c){u.followLinks(JSON.parse(a.response,g),this.expandKeys,b,c)};b.prototype.select=function(a){this.selects=h(a);return this};b.prototype.selectMore=function(a){this.selects=this.selects.concat(h(a));return this};b.prototype.expand=function(a,b,e){a=c(a).toString();
this.selects.push(a);this.expandKeys.push(a);var d=[];b&&d.push("$select="+h(b));e&&(e.top&&d.push("$top="+e.top),e.orderBy&&d.push("$orderby="+c(e.orderBy)+" "+(2!=e.sortOrder?"asc":"desc")),e.filter&&d.push("$filter="+c(e.filter)));this.expands.push(a+(0<d.length?"("+d.join(";")+")":""));return this};b.prototype.getQueryString=function(){var a=[];0<this.selects.length&&a.push("$select="+this.selects.join(","));0<this.expands.length&&a.push("$expand="+this.expands.join(","));var b=this.entitySetName+
"("+this.id+")";this.relatedNav&&(b+="/"+this.relatedNav);return b+(0<a.length?"?"+a.join("&"):"")};b.prototype.includeFormattedValues=function(){this.additionalHeaders.push(p);return this};return b}(n);a.RetrieveRecord=q;q=function(a){function b(b,e){var d=a.call(this,"POST")||this;d.record=e;d.getObjectToSend=function(){return JSON.stringify(l(d.record))};d.entitySetName=c(b).toString();return d}__extends(b,a);b.prototype.handleResponse=function(a,b,c){(a=a.getResponseHeader("OData-EntityId"))?
b(a.substr(-37,36)):c(Error("No valid OData-EntityId found in header."))};b.prototype.setData=function(a){this.record=a;return this};b.prototype.getQueryString=function(){return this.entitySetName};return b}(n);a.CreateRecord=q;q=function(a){function b(b,e){var d=a.call(this,"DELETE")||this;d.id=e;d.entitySetName=c(b).toString();return d}__extends(b,a);b.prototype.handleResponse=function(a,b){b()};b.prototype.setId=function(a){this.id=a;return this};b.prototype.getQueryString=function(){return this.entitySetName+
"("+this.id+")"};return b}(n);a.DeleteRecord=q;n=function(a){function b(b,e,g){var d=a.call(this,"PATCH")||this;d.id=e;d.record=g;d.getObjectToSend=function(){return JSON.stringify(l(d.record))};d.entitySetName=c(b).toString();return d}__extends(b,a);b.prototype.handleResponse=function(a,b){b()};b.prototype.setData=function(a,b){this.id=a;this.record=b;return this};b.prototype.getQueryString=function(){return this.entitySetName+"("+this.id+")"};return b}(n);a.UpdateRecord=n;var v=/function[^\(]*\(([a-zA-Z0-9_]+)[^\{]*\{([\s\S]*)\}$/m;
a.ApiUrl=null;a.getDefaultUrl=k;a.getApiUrl=function(){null===a.ApiUrl&&(a.ApiUrl=k("8.0"));return a.ApiUrl}})(XQW||(XQW={}));
