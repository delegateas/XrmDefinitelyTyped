...
[<assembly: AssemblyVersionAttribute("4.3.8")>]
[<assembly: AssemblyFileVersionAttribute("4.3.8")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.3.8"
    let [<Literal>] AssemblyFileVersion = "4.3.8"
