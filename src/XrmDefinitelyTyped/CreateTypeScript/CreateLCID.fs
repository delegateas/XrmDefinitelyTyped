...
let languages = [|(1025, "Arabic"); (1069, "Basque"); (1026, "Bulgarian"); (1027, "Catalan");
                  (3076, "Chinese (Hong Kong SAR)"); (1050, "Croatian"); (1029, "Czech");
                  ...
                  (1086, "Malay(Malaysia)"); (1044, "Norwegian (Bokmål)"); (1045, "Polish");
                  (1046, "Portuguese (Brazil)"); (2070, "Portuguese (Portugal)");
                  (1048, "Romanian"); (1049, "Russian"); (3098, "Serbian(Cyrillic)");
                  (2074, "Serbian(Latin)"); (1051, "Slovak"); (1060, "Slovenian");
