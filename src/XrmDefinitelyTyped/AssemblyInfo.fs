...
[<assembly: AssemblyVersionAttribute("6.6.1")>]
[<assembly: AssemblyFileVersionAttribute("6.6.1")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "6.6.1"
    let [<Literal>] AssemblyFileVersion = "6.6.1"
