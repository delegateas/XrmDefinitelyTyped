...
namespace XrmQuery {
	...
	export function retrieve<ISelect, IExpand, IFixed, FormattedResult, Result>(
		...
		id: string) {
		return XQW.RetrieveRecord.Get<ISelect, IExpand, IFixed, FormattedResult, Result>(entityPicker, stripGUID(id));
	}
	...
	export function retrieveRelated<ISingle, ISelect, IExpand, IFixed, FormattedResult, Result>(
		...
		return XQW.RetrieveRecord.Related<ISingle, ISelect, IExpand, IFixed, FormattedResult, Result>(entityPicker, stripGUID(id), relatedPicker);
	}
	...
	export function retrieveRelatedMultiple<IMultiple, ISelect, IExpand, IFilter, IFixed, FormattedResult, Result>(
		...
		return XQW.RetrieveMultipleRecords.Related<IMultiple, ISelect, IExpand, IFilter, IFixed, FormattedResult, Result>(entityPicker, stripGUID(id), relatedPicker);
	}
	...
	export function update<IUpdate>(
		...
		id?: string,
		record?: IUpdate) {
		var strippedGuid = id != undefined ? stripGUID(id) : id
		return new XQW.UpdateRecord<IUpdate>(entityPicker, strippedGuid, record);
	}
	...
	export function deleteRecord(
		...
		id?: string) {
		var strippedGuid = id != undefined ? stripGUID(id) : id
		return new XQW.DeleteRecord(entityPicker, strippedGuid);
	}
