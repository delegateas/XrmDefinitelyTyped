...
[<assembly: AssemblyVersionAttribute("4.3.9")>]
[<assembly: AssemblyFileVersionAttribute("4.3.9")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.3.9"
    let [<Literal>] AssemblyFileVersion = "4.3.9"
