...
[<assembly: AssemblyVersionAttribute("4.3.3")>]
[<assembly: AssemblyFileVersionAttribute("4.3.3")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.3.3"
    let [<Literal>] AssemblyFileVersion = "4.3.3"
