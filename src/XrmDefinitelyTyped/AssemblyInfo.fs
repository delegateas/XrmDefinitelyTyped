...
[<assembly: AssemblyVersionAttribute("4.3.6")>]
[<assembly: AssemblyFileVersionAttribute("4.3.6")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.3.6"
    let [<Literal>] AssemblyFileVersion = "4.3.6"
