...
[<assembly: AssemblyVersionAttribute("2.3.12")>]
[<assembly: AssemblyFileVersionAttribute("2.3.12")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "2.3.12"
    let [<Literal>] AssemblyFileVersion = "2.3.12"
