...
[<assembly: AssemblyVersionAttribute("2.3.11")>]
[<assembly: AssemblyFileVersionAttribute("2.3.11")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "2.3.11"
    let [<Literal>] AssemblyFileVersion = "2.3.11"
