...
[<assembly: AssemblyVersionAttribute("4.3.10")>]
[<assembly: AssemblyFileVersionAttribute("4.3.10")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.3.10"
    let [<Literal>] AssemblyFileVersion = "4.3.10"
