...
d),g,m,p,r)}a.setApiUrl=function(a){XQW.ApiUrl=a};a.setApiVersion=function(a){XQW.ApiUrl=XQW.getDefaultUrl(a)};a.retrieveMultiple=function(a){return XQW.RetrieveMultipleRecords.Get(a)};a.retrieveRelatedRecord=function(a,d,f){return XQW.RetrieveRecord.Related(a,d,f)};a.retrieveRelatedMultiple=function(a,d,f){return XQW.RetrieveMultipleRecords.Related(a,d,f)};a.retrieve=function(a,d){return XQW.RetrieveRecord.Get(a,d)};a.create=function(a,d){return new XQW.CreateRecord(a,d)};a.update=function(a,d,f){return new XQW.UpdateRecord(a,
